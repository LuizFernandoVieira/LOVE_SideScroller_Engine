BossSpike         = {}
BossSpike.__index = BossSpike

setmetatable(BossSpike, {
  __index = GameObject,
  __call = function (cls, ...)
...
local BULLET_IMAGE = "img/BossCarrot_Spike.png"
...
function BossSpike:_init(x, y, speed, distanceLeft, speedY)
...
-- @return boolean
function BossSpike:isDead()
  if self.lifeTime:get() > 2 then
    return true
  else
    return false
  end
...
-- @param other
function BossSpike:notifyCollision(other)
